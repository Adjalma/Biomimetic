...
- **Documentação de integração:** pasta [`docs/bio-console/`](docs/bio-console/) (contrato REST, Z-API WhatsApp, ElevenLabs, Google Meet, [Obsidian](docs/bio-console/obsidian-chokmah.md), [roadmap agente](docs/bio-console/agente-roadmap.md)).
